...
- ESP32 toolchain (optional, for firmware build)

### Setup
```bash
git clone https://github.com/Tarun-Sam/MCP-Firmware-Generator.git
cd MCP-Firmware-Generator
python -m venv venv
...
Support for additional microcontrollers (STM32, RP2040)

Integration with cloud-based LLMs

Advanced static analysis and formal verification

Firmware optimization and power analysis

Dataset creation for embedded code generation research
...
AI-assisted program synthesis studies

Final-year projects and theses

Portfolio demonstration for Embedded / VLSI / AI roles
