...
|---------------|----------|--------|
| dhtPin | GPIO25 | const declaration |
| ledPin1 | GPIO26 | const declaration |
| ledPin2 | GPIO27 | const declaration |
| ledPin3 | GPIO28 | const declaration |
| oledSCL | GPIO4 | const declaration |
| oledSDA | GPIO5 | const declaration |
...
pio lib install "ESP32Servo.h"
pio lib install "ArduinoJson.h"
```
...
2. Search and install each library:
   1. Search: `DHT.h`
   2. Search: `ESP32Servo.h`
   3. Search: `ArduinoJson.h`
